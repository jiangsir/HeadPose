...
def show_opencv(hint="", mirror=True, allowESC=True):
    """ 顯示主畫面 """
...
def show_ImageText(
    title, hint, facepath=None, picture=None, identifyfaces=None, personname=None
):
    """ 標準 cv 視窗"""
    import cv2
    import numpy as np
    ...
    draw.rectangle(((W / 2 - w / 2 - 5, 0), (W / 2 + w / 2 + 5, h + 20)), fill="black")
